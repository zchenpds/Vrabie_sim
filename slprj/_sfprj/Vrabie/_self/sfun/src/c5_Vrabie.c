...
static const char * c5_debug_family_names[5] = { "nargin", "nargout", "K", "x",
  "u" };

/* Function Declarations */
static void initialize_c5_Vrabie(SFc5_VrabieInstanceStruct *chartInstance);
static void initialize_params_c5_Vrabie(SFc5_VrabieInstanceStruct *chartInstance);
static void enable_c5_Vrabie(SFc5_VrabieInstanceStruct *chartInstance);
static void disable_c5_Vrabie(SFc5_VrabieInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_Vrabie(SFc5_VrabieInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_Vrabie(SFc5_VrabieInstanceStruct
  *chartInstance);
static void set_sim_state_c5_Vrabie(SFc5_VrabieInstanceStruct *chartInstance,
  const mxArray *c5_st);
static void finalize_c5_Vrabie(SFc5_VrabieInstanceStruct *chartInstance);
static void sf_gateway_c5_Vrabie(SFc5_VrabieInstanceStruct *chartInstance);
static void mdl_start_c5_Vrabie(SFc5_VrabieInstanceStruct *chartInstance);
static void initSimStructsc5_Vrabie(SFc5_VrabieInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_VrabieInstanceStruct *chartInstance,
  const mxArray *c5_b_u, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_VrabieInstanceStruct *chartInstance,
...
static real_T c5_eml_xdotu(SFc5_VrabieInstanceStruct *chartInstance, real_T
  c5_b_x[4], real_T c5_y[4]);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_VrabieInstanceStruct *chartInstance,
  const mxArray *c5_b_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_VrabieInstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_Vrabie, const char_T *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_VrabieInstanceStruct *chartInstance,
  const mxArray *c5_b_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_VrabieInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc5_VrabieInstanceStruct *chartInstance);
...
static void initialize_c5_Vrabie(SFc5_VrabieInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Vrabie = 0U;
}
  ...
  *chartInstance)
{
  ...
  c5_b_hoistedGlobal = chartInstance->c5_is_active_c5_Vrabie;
  ...
  const mxArray *c5_st)
{
  ...
  *chartInstance->c5_u = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_b_u, 0)), "u");
  chartInstance->c5_is_active_c5_Vrabie = c5_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_b_u, 1)), "is_active_c5_Vrabie");
  sf_mex_destroy(&c5_b_u);
  c5_update_debugger_state_c5_Vrabie(chartInstance);
...
static void sf_gateway_c5_Vrabie(SFc5_VrabieInstanceStruct *chartInstance)
{
  ...
  for (c5_i0 = 0; c5_i0 < 4; c5_i0++) {
    c5_b_K[c5_i0] = (*chartInstance->c5_K)[c5_i0];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 1U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_b_K, 2U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_b_x, 3U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_u, 4U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 3);
  for (c5_i2 = 0; c5_i2 < 4; c5_i2++) {
    c5_a[c5_i2] = -c5_b_K[c5_i2];
  }

  for (c5_i3 = 0; c5_i3 < 4; c5_i3++) {
    c5_b[c5_i3] = c5_b_x[c5_i3];
  }

  for (c5_i4 = 0; c5_i4 < 4; c5_i4++) {
    c5_b_a[c5_i4] = c5_a[c5_i4];
  }

  for (c5_i5 = 0; c5_i5 < 4; c5_i5++) {
    c5_b_b[c5_i5] = c5_b[c5_i5];
  }

  c5_b_u = c5_eml_xdotu(chartInstance, c5_b_a, c5_b_b);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c5_u = c5_b_u;
  ...
  for (c5_i6 = 0; c5_i6 < 4; c5_i6++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c5_K)[c5_i6], 1U);
  }

  for (c5_i7 = 0; c5_i7 < 4; c5_i7++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c5_x)[c5_i7], 2U);
  }
}
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_b_u;
  const mxArray *c5_y = NULL;
  SFc5_VrabieInstanceStruct *chartInstance;
  chartInstance = (SFc5_VrabieInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_Vrabie_get_eml_resolved_functions_info(void)
{
  const mxArray *c5_nameCaptureInfo = NULL;
  c5_nameCaptureInfo = NULL;
  sf_mex_assign(&c5_nameCaptureInfo, sf_mex_createstruct("structure", 2, 26, 1),
                false);
...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m"),
                  "resolved", "resolved", 2);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1323145378U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/eml_mtimes_helper.m"),
                  "context", "context", 6);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_xdotu"), "name", "name", 6);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdotu.m"),
                  "resolved", "resolved", 6);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1375959090U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/inline.p"),
                  "resolved", "resolved", 7);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1410786172U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1393305658U), "fileTimeLo",
                  "fileTimeLo", 12);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 12);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1372561560U), "fileTimeLo",
                  "fileTimeLo", 16);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 16);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1397235822U), "fileTimeLo",
                  "fileTimeLo", 19);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 19);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 20);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("isfi"), "name", "name", 20);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("coder.internal.indexInt"),
                  "dominantType", "dominantType", 20);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isfi.m"), "resolved",
                  "resolved", 20);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1346488758U), "fileTimeLo",
                  "fileTimeLo", 20);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 20);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isnumerictype.m"), "resolved",
                  "resolved", 21);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1398853998U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
                  "resolved", 22);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1362236682U), "fileTimeLo",
                  "fileTimeLo", 22);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 22);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 24);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("intmin"), "name", "name", 24);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  c5_b_x[4], real_T c5_y[4])
{
  ...
  for (c5_k = 1; c5_k < 5; c5_k++) {
    c5_b_k = c5_k;
    c5_d += c5_b_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
      "", (real_T)c5_b_k), 1, 4, 1, 0) - 1] * c5_y[_SFD_EML_ARRAY_BOUNDS_CHECK(
      "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c5_b_k), 1, 4, 1, 0) - 1];
  }
  ...
  const mxArray *c5_b_u, const emlrtMsgIdentifier *c5_parentId)
{
  ...
  int32_T c5_i10;
  (void)chartInstance;
  sf_mex_import(c5_parentId, sf_mex_dup(c5_b_u), &c5_i10, 1, 6, 0U, 0, 0U, 0);
  c5_y = c5_i10;
  sf_mex_destroy(&c5_b_u);
  return c5_y;
}
  ...
  const mxArray *c5_b_is_active_c5_Vrabie, const char_T *c5_identifier)
{
  ...
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_Vrabie), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_Vrabie);
  return c5_y;
}
...
static void init_simulink_io_address(SFc5_VrabieInstanceStruct *chartInstance)
{
  chartInstance->c5_u = (real_T *)ssGetOutputPortSignal_wrapper(chartInstance->S,
    1);
  chartInstance->c5_K = (real_T (*)[4])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c5_x = (real_T (*)[4])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c5_Vrabie_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3960523349U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1764980188U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3794026587U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(462347808U);
}

mxArray* sf_c5_Vrabie_get_post_codegen_info(void);
mxArray *sf_c5_Vrabie_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("As9WF1MbiOhIm0cNIzJ9yC");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c5_Vrabie_get_post_codegen_info();
...
mxArray *sf_c5_Vrabie_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_Vrabie_jit_fallback_info(void)
{
...
mxArray *sf_c5_Vrabie_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_Vrabie(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"u\",},{M[8],M[0],T\"is_active_c5_Vrabie\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Vrabie_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_VrabieInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,34);
        ...
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c5_K);
...
{
  return "UwR9DgW0IWEr7l3yQeczqD";
}

static void sf_opaque_initialize_c5_Vrabie(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_VrabieInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c5_Vrabie((SFc5_VrabieInstanceStruct*) chartInstanceVar);
  initialize_c5_Vrabie((SFc5_VrabieInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_Vrabie(void *chartInstanceVar)
{
  enable_c5_Vrabie((SFc5_VrabieInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_Vrabie(void *chartInstanceVar)
{
  disable_c5_Vrabie((SFc5_VrabieInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_Vrabie(void *chartInstanceVar)
{
  sf_gateway_c5_Vrabie((SFc5_VrabieInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_Vrabie(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c5_Vrabie((SFc5_VrabieInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_Vrabie(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c5_Vrabie((SFc5_VrabieInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c5_Vrabie(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_VrabieInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_Vrabie((SFc5_VrabieInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_Vrabie((SFc5_VrabieInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Vrabie(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c5_Vrabie((SFc5_VrabieInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_Vrabie(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1541221564U));
  ssSetChecksum1(S,(2716826970U));
  ssSetChecksum2(S,(700732230U));
  ssSetChecksum3(S,(4065778703U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_Vrabie(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_Vrabie(SimStruct *S)
{
  SFc5_VrabieInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_VrabieInstanceStruct *)utMalloc(sizeof
    (SFc5_VrabieInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_VrabieInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_Vrabie;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_Vrabie;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_Vrabie;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_Vrabie;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_Vrabie;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_Vrabie;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_Vrabie;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_Vrabie;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_Vrabie;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_Vrabie;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_Vrabie;
...
void c5_Vrabie_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Vrabie(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Vrabie(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Vrabie(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Vrabie_method_dispatcher.\n"
